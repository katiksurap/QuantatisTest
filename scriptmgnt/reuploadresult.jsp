...
/////////////////// for radio mirchi ///////////////////////             
                ...
                //////////////end mail////////////
response.sendRedirect("campaignexistscript.jsp?scriptid=" + scrId + "&name=" + cname + "&sts=Script added Succesfully.");
            } else {
                response.sendRedirect("campaignexistscript.jsp?sts=Script adding Failed.");
            }
