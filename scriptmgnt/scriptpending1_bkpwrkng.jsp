...
%> 
                ...
                <td align="center"><a  href="<%=response.encodeURL("scriptView.jsp?name=" + cname1)%>"><input type="button" value="Single Upload"/></a><br><br><a  href="<%=response.encodeURL("scriptView2.jsp?name=" + cname1)%>"><input type="button" value="Multiple Upload"/></a></td>
