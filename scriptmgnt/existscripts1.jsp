...
<html>
    ...
    <body>
        ...
        %>
 <br><br> <table align="center"><td><a  href="<%=response.encodeURL("report.jsp")%>"><input type="button" value="Go Back" class="btn" ></a></td></table> 
<form action="existscripts1.jsp" method="post" >
        ...
        <table align="center"  border="1"   id="mytable" class="attable">
            ...
            <tr>
                ...
                <td><div style="width:230px; height:150px; overflow-x:hidden; overflow-y:scroll;  margin:0px auto; clear:both; overflow:auto;">
