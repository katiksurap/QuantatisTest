   ...
   var b = confirm('Are You Sure You Want To Delete This Campaign');
    ...
    <body>
        ...
        <% // if ((request.getParameter("sdate") != null) && (request.getParameter("edate") != null)) {
            ...
            String assaignedto=session.getAttribute("user_type").toString();
            ...
            if (insrt_art_in_session == 1) {
               ...
               if(assaignedto.equalsIgnoreCase("operator")){
                  art = pgn.showdetailsbydateall(stdate, edate,status,assaignedto); 
               }else{
                art = pgn.showdetailsbydate(stdate, edate,status,assaignedto);
            ...
            if (Tot_Recs == 0) {
                ...
                out.println("<br><br><center>" + "No Records found to display" + "</center>");
            } else {
        %>
...
%>
            ...
            <%
                    ...
                    if (art.size() > 0) {
                        ...
                        out.println(paging.FooterHtml(PageNo, art.size(), MNRPP, "existdatesres.jsp", stdate, edate));
                    }
                }
