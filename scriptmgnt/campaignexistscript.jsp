...
filesize=fs.getsize(pgb.getScriptUpload_path());
   ...
   <td> <a href="download.jsp?fname=<%=pgb.getScriptUpload_fname()%>&userid=<%=pgb.getUser_id()%>" style="color: #A42300">
                     <%=pgb.getScriptUpload_fname()%></a><br><span style="color: red">File Size Is <%=filesize%> </span><br>
...
<br><br>
                     <a href="<%=response.encodeURL("reupload.jsp?scriptid=" +pgb.getScript_id())%>" class="btn" onclick="javascript:return(confirm('Do You want to Re-upload This Script?'));">Re-upload</a><%
