...
<html>
    ...
    <body>
        <form action="reuploadresult.jsp" method="post" enctype="multipart/form-data" onsubmit="return scriptvalidation()" >

        <%

            String scriptid = request.getParameter("scriptid");
            System.out.println("Script id is=" + scriptid);
            ...
            try {
                ...
                query = "select * from  scripts where script_id='" + scriptid + "'";
        ...
        <table align="center"  border="1"   id="mytable" class="attable">
            ...
            <tr>
                <td>
                    <%=rs.getInt("script_id")%><% int sId = rs.getInt("script_id");
                        session.setAttribute("scriptId", sId);%>
                </td><input type="hidden" name="scriptid" value="<%=rs.getInt("script_id")%>">
            <td>
    ...
    </form><br><table align="center"><td><a  href="<%=response.encodeURL("campaignexistscript.jsp")%>"><input type="button" value="Go Back" class="btn" ></a></td></table>
                <% } else {
                            System.out.println("Else loop no records were there");
