    ...
    <body>
        <%
           ...
           //cname = session.getAttribute("cname2").toString();
            ...
            String assignedTo =mrequest.getParameter("assgnto");
...
//String qry="insert into scripts(scriptUpload_fname,scriptUpload_path,script_status,script_status) values(?,?,2) WHERE campaignname =?";
                ...
                if(res>0){
                    ...
                    //////////////end mail////////////    
                    response.sendRedirect("rejectscripts1.jsp?name="+cname+"&sts=Script updated for "+checkbox+" Succesfully for campaign "+cname+".");
                                   }else{
                    response.sendRedirect("rejectscripts1.jsp?name='"+cname+"'&sts=Script updating Failed.");
